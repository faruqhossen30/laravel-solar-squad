...
">
    <div class="lg:py-[50px] py-10  space-y-6 bg-right bg-no-repeat mx-auto  " >
        <h6 class="text-left capitalize px-6 lg:text-center text-white  text-xl lg:text-[36px] font-bold font-display aminate_animated animate__zoomIn"data-aos="fade-left" data-aos-anchor="#example-anchor"
            data-aos-offset="300" data-aos-easing="ease-in-sine" data-aos-duration="2000">Take the Next Step</h6>
        <h2 class="text-left lg:text-center  text-white text-4xl leading-[40px]  md:text-6xl md:leading-[60px] lg:text-[80px] lg:leading-[90px] px-6  font-extrabold font-display"data-aos="fade-right" data-aos-anchor="#example-anchor" data-aos-offset="300"
        ...
        <p class="text-left lg:text-center capitalize  text-white lg:text-[20px] px-6 font-medium font-display"data-aos="zoom-in" data-aos-anchor="#example-anchor" data-aos-offset="300"
            ...
            your <br class="hidden xl:block"> questions
            answered. Whether you’re curious about the details or ready to get started, we’re here to help. <br class="hidden xl:block"> Please note that to ensure the success of our new advisors each
