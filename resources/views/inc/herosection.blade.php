<section class="w-full  h-screen bg-no-repeat  bg-cover" style="background-image: url('img/young-beautiful-smiling-model-using-new-laptop-citypark-sunny-day.jpg')">

    <div class=" absluate inset-0 bg-gray-900 bg-center   opacity-65 h-screen">
