        ...
        <div class="grid grid-cols-12 lg:gap-10 lg:px-14">
            ...
            <div class="lg:col-span-6 col-span-12 py-12 lg:py-24 lg:pl-20 space-y-5" data-aos="fade-left" data-aos-duration="2000">
                ...
                <div class=" space-y-6 ">
                    ...
                    <h3 class="text-[40px] font-bold font-display text-[#334155]  text-left"  >About Solar Squad</h3>
                    <p class=" text-[24px] font-display capitalize text-[#475569]  text-left">At Solar Squad, we are committed to helping individuals like you find the best opportunities to earn extra
                        income while supporting clean energy initiatives.
                    </p>
                </div>
                <div class="space-y-6 py-6">
                    <h3 class="text-[40px] font-bold font-display text-[#334155]  text-left">Our Mission</h3>
                    <p class="text-[23px] font-display text-[#475569] capitalize text-justify">Our mission is to connect you with the top community solar providers in the industry, ensuring you have access
