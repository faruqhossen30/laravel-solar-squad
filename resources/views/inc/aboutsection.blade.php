    ...
    <div class="container mx-auto">
        <div class="grid grid-cols-12 lg:gap-3">
            ...
            <div class="lg:col-span-6 col-span-12 py-12 lg:py-24" data-aos="fade-left" data-aos-duration="2000">
                ...
                <div class="space-y-6 py-6 px-6 lg:px-0">

                    <h3 class="text-3xl font-bold font-display text-[#334155]  text-center lg:text-left">Our Mission</h3>
                    <p class="font-display text-[#475569] capitalize  text-center lg:text-left">Our mission is to connect you with the top community solar providers in the industry, ensuring you have access
                ...
                <div class="py-6 text-center lg:text-left">
                    <a href="#" class="inline-flex justify-center items-center bg-[#2563EB] px-6 py-2  rounded-lg text-white">
