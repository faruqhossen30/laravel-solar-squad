<section class="bg-[#F1F5F9] py-36 bg-cover object-center bg-no-repeat" style="background-image: url('img/solar.png')">
    <div class="flex justify-center items-center">
        <span class="relative flex items-center justify-center h-24 w-24">
            ...
            <button href="https://www.youtube.com/watch?v=2qQlK-c4s8o"  class="video-popupbutton flex items-center justify-center rounded-full h-24 w-24 bg-white z-50">
