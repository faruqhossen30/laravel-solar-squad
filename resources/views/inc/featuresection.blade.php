            ...
            @foreach ($services as $item)
                <div class="border-2 border-gray-300 rounded-xl lg:hover:shadow-2xl" style="min-height: 100% !important">
                    ...
                    <div class="px-8 py-5 lg:py-12 space-y-4 lg:space-y-8">
                        <h3 class="text-[16px] lg:text-xl xl:text-[26px] capitalize font-semibold font-display text-[#334155]">{{ $item->title }}</h3>
                        <p class="text-base md:text-base lg:text-lg xl:text-xl capitalize  font-normal font-display text-[#334155] ">{{ $item->description }}</p>
