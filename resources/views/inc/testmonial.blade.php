...
@endphp
<section class="bg-[#F8FAFC] px-3 lg:px-0 hidden lg:block">
                    ...
                    <div class="col-span-12 lg:col-span-6  ">
                        <div class="flex justify-center lg:-mb-[110px] -mb-[80px]">
                            <img src="{{ asset('storage/' . $testmonial->thumbnail) }}"
                                class=" object-cover  object-top lg:max-h-[220px] lg:min-h-[220px] lg:min-w-[220px] lg:max-w-[220px] max-h-[180px] min-h-[180px] min-w-[180px] max-w-[180px]  border-8 border-white rounded-full " alt="">
                        </div>

                        <div class="bg-[#E2E8F0] rounded-3xl">

                            <div class="flex items-center justify-between px-10 lg:pt-24 pt-14">
                                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" class="lg:h-24 lg:w-24 h-16 w-16" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                ...
                                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" class="lg:h-24 lg:w-24 h-16 w-16 rotate-180" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
...
<section class="bg-[#F8FAFC] px-3 lg:px-0 lg:hidden">
    <div class="lg:w-[1515px]   mx-auto lg:py-44 py-10 px-5 ">
            ...
            @foreach ($testmonials as $testmonial)
                <div class="col-span-12 ">
                    ...
                    <div class="bg-[#E2E8F0] rounded-3xl">
                        ...
                        <p class=" px-6 text-justify text-[19px] font-normal font-display text-[#475569]">
                            <?php echo substr($testmonial->description, 0, 315); ?></p>
